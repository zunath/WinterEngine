...
namespace WinterEngine.Toolset.Controls.XnaControls.Shared
{
    ...
    /// or disposed.
    /// </summary>
    class XNAGraphicsDeviceService : IGraphicsDeviceService
    {
        #region Fields


        // Singleton device service instance.
        static XNAGraphicsDeviceService singletonInstance;
        ...
        /// </summary>
        XNAGraphicsDeviceService(IntPtr windowHandle, int width, int height)
        {
