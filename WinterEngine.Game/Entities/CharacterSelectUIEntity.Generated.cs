...
{
	public partial class CharacterSelectUIEntity : WinterEngine.Game.Entities.GuiBaseEntity, IDestroyable, IVisible
	{
        ...
        public CharacterSelectUIEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public CharacterSelectUIEntity(string contentManagerName, bool addToManagers) :
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("CharacterSelectUIEntityStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class CharacterSelectUIEntityExtensionMethods
	{
		public static void SetVisible (this PositionedObjectList<CharacterSelectUIEntity> list, bool value)
		{
