...
{
	public partial class PartyGuiEntity : WinterEngine.Game.Entities.GuiBaseEntity, IDestroyable, IVisible, IWindow, IClickable
	{
        ...
        public PartyGuiEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public PartyGuiEntity(string contentManagerName, bool addToManagers) :
...
// Generated AddToManagers
		...
		public override void PostInitialize ()
		{
			...
			Width = 100;
			IsTransparent = false;
			ResourcePath = "file:///./Components/Party.html";
			X = 0f;
			Y = 0f;
			ScaleX = 0.5f;
			ScaleY = 0.5f;
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("PartyGuiEntityStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class PartyGuiEntityExtensionMethods
	{
		public static void SetVisible (this PositionedObjectList<PartyGuiEntity> list, bool value)
		{
