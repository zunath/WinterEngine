...
{
	public partial class MiniMapGuiEntity : WinterEngine.Game.Entities.GuiBaseEntity, IDestroyable, IVisible, IWindow, IClickable
	{
        ...
        public MiniMapGuiEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public MiniMapGuiEntity(string contentManagerName, bool addToManagers) :
...
// Generated AddToManagers
		...
		public override void PostInitialize ()
		{
			...
			base.PostInitialize();
			IsTransparent = false;
			ResourcePath = "file:///./Components/MiniMap.html";
			X = 0f;
			Y = 0f;
			ScaleX = 1f;
			ScaleY = 1f;
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("MiniMapGuiEntityStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class MiniMapGuiEntityExtensionMethods
	{
		public static void SetVisible (this PositionedObjectList<MiniMapGuiEntity> list, bool value)
		{
