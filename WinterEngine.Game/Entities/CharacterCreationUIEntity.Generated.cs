...
{
	public partial class CharacterCreationUIEntity : WinterEngine.Game.Entities.GuiBaseEntity, IDestroyable
	{
        ...
        public CharacterCreationUIEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public CharacterCreationUIEntity(string contentManagerName, bool addToManagers) :
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("CharacterCreationUIEntityStaticUnload", UnloadStaticContent);
