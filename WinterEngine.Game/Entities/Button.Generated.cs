...
// Generated AddToManagers
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/button/animationchainlistfile.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimationChainListFile = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/button/animationchainlistfile.achx", ContentManagerName);
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/entities/button/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/entities/button/scenefile.scnx", ContentManagerName);
			}
		...
		public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue)
		{
			...
			switch(firstState)
			{
				case  VariableState.Regular:
					...
					{
						this.SpriteFrameInstanceCurrentChainName = "Regular";
					}
					break;
				case  VariableState.Pressed:
					if (interpolationValue < 1)
					{
						this.SpriteFrameInstanceCurrentChainName = "Pressed";
					}
					break;
				case  VariableState.Disabled:
					if (interpolationValue < 1)
					{
						this.SpriteFrameInstanceCurrentChainName = "Disabled";
					}
					break;
				case  VariableState.Hover:
					if (interpolationValue < 1)
					{
						this.SpriteFrameInstanceCurrentChainName = "Hover";
					}
					break;
			}
			switch(secondState)
