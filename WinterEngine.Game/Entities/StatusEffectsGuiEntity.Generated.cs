...
{
	public partial class StatusEffectsGuiEntity : WinterEngine.Game.Entities.GuiBaseEntity, IDestroyable, IVisible, IWindow, IClickable
	{
        ...
        public StatusEffectsGuiEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public StatusEffectsGuiEntity(string contentManagerName, bool addToManagers) :
...
// Generated AddToManagers
		...
		public override void PostInitialize ()
		{
			...
			base.PostInitialize();
			IsTransparent = false;
			ResourcePath = "file:///./Components/StatusEffects.html";
			X = 0f;
			Y = 0f;
			ScaleX = 1f;
			ScaleY = 1f;
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("StatusEffectsGuiEntityStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class StatusEffectsGuiEntityExtensionMethods
	{
		public static void SetVisible (this PositionedObjectList<StatusEffectsGuiEntity> list, bool value)
		{
