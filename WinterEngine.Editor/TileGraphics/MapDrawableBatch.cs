...
namespace FlatRedBall.TileGraphics
{
    public class MapDrawableBatch: PositionedObject, IDrawableBatch
    {
        ...
        public MapDrawableBatch(int numberOfTiles, Texture2D texture) : base()
        {
            if (texture == null)
        ...
        public void Paste(Sprite sprite, bool setZTo0 = false)
        {
        ...
        public void Paste(SpriteSave spriteSave, bool setZTo0 = false)
        {
            ...
            // add the textured tile to our map so that we may draw it.
            AddTile(new Vector3(x, y, z), new Vector2(width, height), new Vector4(leftTextureCoordinate, rightTextureCoordinate, topTextureCoordinate, bottomTextureCoordinate));
        }
