...
var MappingEnum = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.Enumerations.MappingEnum, WinterEngine.DataTransferObjects';
...
MappingEnum.prototype = new extendable();
