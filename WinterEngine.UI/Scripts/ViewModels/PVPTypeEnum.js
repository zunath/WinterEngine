...
var PVPTypeEnum = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.Enumerations.PVPTypeEnum, WinterEngine.DataTransferObjects';
...
PVPTypeEnum.prototype = new extendable();
