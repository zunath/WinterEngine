...
var ItemType = function()
{
	...
	self.$type = 'WinterEngine.DataTransferObjects.ItemType, WinterEngine.DataTransferObjects';

	self.HasIcon = ko.observable();
    ...
    self.setModel = function(objFromServer) {
	  ...
	  self.HasIcon(objFromServer.HasIcon);
	  self.IconWidth(objFromServer.IconWidth);
	  self.IconHeight(objFromServer.IconHeight);
...
ItemType.prototype = new extendable();
