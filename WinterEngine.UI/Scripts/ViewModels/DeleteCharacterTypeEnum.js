...
var DeleteCharacterTypeEnum = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.Enumerations.DeleteCharacterTypeEnum, WinterEngine.DataTransferObjects';
...
DeleteCharacterTypeEnum.prototype = new extendable();
