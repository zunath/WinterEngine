...
var ObjectSelectionEventArgs = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.EventArgsExtended.ObjectSelectionEventArgs, WinterEngine.DataTransferObjects';
...
ObjectSelectionEventArgs.prototype = new extendable();
