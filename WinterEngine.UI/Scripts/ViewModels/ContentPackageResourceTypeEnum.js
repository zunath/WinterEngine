...
var ContentPackageResourceTypeEnum = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.Enumerations.ContentPackageResourceTypeEnum, WinterEngine.DataTransferObjects';
...
ContentPackageResourceTypeEnum.prototype = new extendable();
