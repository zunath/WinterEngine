...
var PlayerCharacter = function()
{
	...
	self.$type = 'WinterEngine.DataTransferObjects.GameObjects.PlayerCharacter, WinterEngine.DataTransferObjects';

	self.PlayerID = ko.observable();
	self.Age = ko.observable();
	self.IsGameMaster = ko.observable();
    ...
    self.setModel = function(objFromServer) {
	  ...
	  self.PlayerID(objFromServer.PlayerID);
	  self.Age(objFromServer.Age);
	  self.IsGameMaster(objFromServer.IsGameMaster);
	  self.FileName(objFromServer.FileName);
	  self.Experience(objFromServer.Experience);
...
PlayerCharacter.prototype = new extendable();
