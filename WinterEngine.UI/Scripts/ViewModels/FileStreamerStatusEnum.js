...
var FileStreamerStatusEnum = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.Enumerations.FileStreamerStatusEnum, WinterEngine.DataTransferObjects';
...
FileStreamerStatusEnum.prototype = new extendable();
