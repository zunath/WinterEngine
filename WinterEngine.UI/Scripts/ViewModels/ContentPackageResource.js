...
var ContentPackageResource = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.ContentPackageResource, WinterEngine.DataTransferObjects';

	self.FileName = ko.observable();
	self.ContentPackageResourceTypeID = ko.observable();
	self.ContentPackageResourceType = ko.observable();
	self.ContentPackage = ko.observable();
    ...
    self.setModel = function(objFromServer) {
	  ...
	  self.ContentPackageResourceTypeID(objFromServer.ContentPackageResourceTypeID);
	  if (objFromServer.ContentPackageResourceType) {
        var __ContentPackageResourceType = new ContentPackageResourceTypeEnum();
	    __ContentPackageResourceType.setModel(objFromServer.ContentPackageResourceType);
	    self.ContentPackageResourceType(__ContentPackageResourceType);
	  }
	  else
		self.ContentPackageResourceType(null);
	  if (objFromServer.ContentPackage) {
        var __ContentPackage = new ContentPackage();
	    __ContentPackage.setModel(objFromServer.ContentPackage);
	    self.ContentPackage(__ContentPackage);
	  }
	  else
		self.ContentPackage(null);
...
ContentPackageResource.prototype = new extendable();
