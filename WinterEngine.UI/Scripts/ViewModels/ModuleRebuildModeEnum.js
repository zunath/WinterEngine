...
var ModuleRebuildModeEnum = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.Enumerations.ModuleRebuildModeEnum, WinterEngine.DataTransferObjects';
...
ModuleRebuildModeEnum.prototype = new extendable();
