...
var GameObjectTypeEnum = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.Enumerations.GameObjectTypeEnum, WinterEngine.DataTransferObjects';
...
GameObjectTypeEnum.prototype = new extendable();
