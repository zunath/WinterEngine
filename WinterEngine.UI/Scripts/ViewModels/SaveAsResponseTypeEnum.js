...
var SaveAsResponseTypeEnum = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.Enumerations.SaveAsResponseTypeEnum, WinterEngine.DataTransferObjects';
...
SaveAsResponseTypeEnum.prototype = new extendable();
