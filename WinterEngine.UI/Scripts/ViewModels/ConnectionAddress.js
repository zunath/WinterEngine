...
var ConnectionAddress = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.BusinessObjects.ConnectionAddress, WinterEngine.DataTransferObjects';

	self.ServerIPAddress = ko.observable();
    ...
    self.setModel = function(objFromServer) {
	  ...
	  self.ServerIPAddress(objFromServer.ServerIPAddress);
...
ConnectionAddress.prototype = new extendable();
