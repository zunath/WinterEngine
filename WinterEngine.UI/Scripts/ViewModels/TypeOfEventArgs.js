...
var TypeOfEventArgs = function()
{
	var self = this;

	//	Type of the original .NET model. Must stay first ! (required for JSON.NET)
	self.$type = 'WinterEngine.DataTransferObjects.EventArgsExtended.TypeOfEventArgs, WinterEngine.DataTransferObjects';
    ...
    self.setModel = function(objFromServer) {
	  ...
	  self.ObjectType(objFromServer.ObjectType);
...
TypeOfEventArgs.prototype = new extendable();
